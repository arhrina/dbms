...
타 DBMS(mysql, mssql)등에서는 기본적인 Schema를 
DATABASE라는 이름으로 생성하여 관리한다.

오라클에서는 기본 Schema가 USER와 밀접한 관련이 있다.
USER = DataBase 기본 Schema의 관점으로 생각을 해야한다.

USER란?
DBMS Object들(TABLE, VIEW, SEQUENCE, INDEX...)
을 관리하는 주체

만약 USER5로 접속하여 USER4가 가지고 있는 어떤 TABLE을 
SELET 하고 싶다?
